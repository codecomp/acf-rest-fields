...
class Acf_Rest_Fields {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Acf_Rest_Fields_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		...
		$this->plugin_name = 'acf-rest-fields';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-acf-rest-fields-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-acf-rest-fields-i18n.php';
	 ...
	 *
	 * Uses the Acf_Rest_Fields_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Acf_Rest_Fields_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Acf_Rest_Fields_Admin( $this->get_plugin_name(), $this->get_version() );

		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_styles' );
		$this->loader->add_action( 'admin_enqueue_scripts', $plugin_admin, 'enqueue_scripts' );
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'add_admin_options_pages' );
		$this->loader->add_action( 'admin_init', $plugin_admin, 'admin_options_settings_init' );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Acf_Rest_Fields_Loader    Orchestrates the hooks of the plugin.
	 */
